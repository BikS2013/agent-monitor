  ...
  return (
    <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="bg-white p-3 rounded shadow-sm flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="font-medium">{group.adminUsers.length}</div>
            </div>
          </div>
          ...
          <div className="bg-white p-3 rounded shadow-sm flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="font-medium capitalize">{group.purpose}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4">
          <h3 className="text-lg font-medium mb-4">Collections in this Group</h3>
      ...
      <div className="p-4 bg-white border-t">
        ...
        <div className="space-y-2">
          {group.adminUsers.map((adminId) => (
            <div key={adminId} className="flex items-center justify-between p-2 bg-gray-50 rounded">
              <div className="flex items-center">
